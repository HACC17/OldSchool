...
<html>
    ...
    <body>
        ...
        <div id="show-volunteer" class="content scaffold-show" role="main">
            ...
            <f:display bean="volunteer" />
            <g:form resource="${this.volunteer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.volunteer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
